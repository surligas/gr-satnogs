...
# Generated: Mon May 15 21:40:52 2017
##################################################
...
class upsat_transceiver_cli_uhd_pa(gr.top_block):
    ...
    def __init__(self, bind_addr='0.0.0.0', dest_addr='127.0.0.1', lo_offset=100e3, recv_port=16886, rx_sdr_device='usrpb200', send_port=5022, tx_sdr_device='usrpb200', wod_port=5023):
        ...
        self.uhd_usrp_source_0.set_center_freq(rx_frequency - lo_offset, 0)
        self.uhd_usrp_source_0.set_gain(satnogs.hw_rx_settings[rx_sdr_device]['rf_gain'], 0)
        self.uhd_usrp_source_0.set_antenna('RX2', 0)
        self.uhd_usrp_source_0.set_bandwidth(samp_rate_rx, 0)
        ...
        self.uhd_usrp_sink_0.set_center_freq(tx_frequency - lo_offset, 0)
    ...
    def set_lo_offset(self, lo_offset):
        self.lo_offset = lo_offset
        self.uhd_usrp_source_0.set_center_freq(self.rx_frequency - self.lo_offset, 0)
        self.uhd_usrp_sink_0.set_center_freq(self.tx_frequency - self.lo_offset, 0)
    ...
    def set_rx_sdr_device(self, rx_sdr_device):
        ...
        self.uhd_usrp_source_0.set_gain(satnogs.hw_rx_settings[self.rx_sdr_device]['rf_gain'], 0)
    ...
    def set_tx_sdr_device(self, tx_sdr_device):
        self.tx_sdr_device = tx_sdr_device
        self.uhd_usrp_sink_0.set_gain(satnogs.hw_tx_settings[self.tx_sdr_device]['rf_gain'], 0)
    ...
    def set_samp_rate_rx(self, samp_rate_rx):
        ...
        self.uhd_usrp_source_0.set_bandwidth(self.samp_rate_rx, 0)
    ...
    def set_samp_rate_tx(self, samp_rate_tx):
        ...
        self.uhd_usrp_sink_0.set_bandwidth(self.samp_rate_tx, 0)
        self.pfb_arb_resampler_xxx_0.set_rate(self.samp_rate_tx / (self.baud_rate_uplink * self.samples_per_symbol_tx))
...
def main(top_block_cls=upsat_transceiver_cli_uhd_pa, options=None):
    if options is None:
